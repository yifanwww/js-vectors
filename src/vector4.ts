...
export class Vector4 {
    ...
    /**
     * Copies the values of the passed vector's x, y, z and w components to this vector.
     ...
     */
    static addScalar(left: Vector4, right: number) {
     ...
     */
    static sub(left: Vector4, right: Vector4) {
        return new Vector4(left.x - right.x, left.y - right.y, left.z - right.z, left.w - right.w);
    }
     ...
     * @param right The scalar value.
     */
    static subScalar(left: Vector4, right: number) {
        return new Vector4(left.x - right, left.y - right, left.z - right, left.w - right);
    }
     ...
     * @param right The second vector.
     */
    static mul(left: Vector4, right: Vector4) {
        return new Vector4(left.x * right.x, left.y * right.y, left.z * right.z, left.w * right.w);
    }
     ...
     * @param right The scalar value.
     */
    static mulScalar(left: Vector4, right: number) {
        return new Vector4(left.x * right, left.y * right, left.z * right, left.w * right);
    }
     ...
     * @param right The second vector.
     */
    static div(left: Vector4, right: Vector4) {
        return new Vector4(left.x / right.x, left.y / right.y, left.z / right.z, left.w / right.w);
    }
     ...
     * @param right The scalar value.
     */
    static divScalar(left: Vector4, right: number) {
        return new Vector4(left.x / right, left.y / right, left.z / right, left.w / right);
    }
     ...
     */
    static clamp(value: Vector4, min: Vector4, max: Vector4) {
        return new Vector4(
     ...
     * @param max The maximum value.
     */
    static clampScalar(value: Vector4, min: number, max: number) {
        return new Vector4(
     ...
     */
    static floor(value: Vector4) {
        return new Vector4(Math.floor(value.x), Math.floor(value.y), Math.floor(value.z), Math.floor(value.w));
    }
     ...
     * @param value The vector.
     */
    static ceil(value: Vector4) {
        return new Vector4(Math.ceil(value.x), Math.ceil(value.y), Math.ceil(value.z), Math.ceil(value.w));
    }
     ...
     * @param value The vector.
     */
    static round(value: Vector4) {
        return new Vector4(Math.round(value.x), Math.round(value.y), Math.round(value.z), Math.round(value.w));
    }
     ...
     * @param value The vector.
     */
    static roundToZero(value: Vector4) {
        return new Vector4(
            ...
            value.w < 0 ? Math.ceil(value.w) : Math.floor(value.w),
        );
    }
    ...
    static normalize(value: Vector4) {
        return Vector4.divScalar(value, value.length());
    }
     ...
     * @param b The second vector.
     */
    static distanceSq(a: Vector4, b: Vector4) {
        const dx = a.x - b.x;
        const dy = a.y - b.y;
        const dz = a.z - b.z;
        const dw = a.w - b.w;
    ...
    static distance(a: Vector4, b: Vector4) {
        return Math.sqrt(Vector4.distanceSq(a, b));
    }
     ...
     */
    static lerp(a: Vector4, b: Vector4, alpha: number) {
